...
function Card(props: any) {
  return (
    ...
    <div className="cursor-pointer bg-white h-[450px] md:my-6 overflow-hidden  font-semibold flex-row items-center justify-center text-center rounded-xl border shadow-lg p-1 max-w-xs">
      {/* date and bookmark */}
      ...
      <div className="flex items-center">
        <div className="bg-white w-[300px] overflow-hidden  h-[350px] rounded-xl ">
          <div className="flex justify-between items-center p-3">
            ...
            <button type="button" className="btn btn-primary btn-md">Details</button>
          </div>
        </div>
      </div>
    </div>
