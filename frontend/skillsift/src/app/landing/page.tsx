      ...
      <div className="flex w-screen h-screen flex-col text-black p-5">
        <nav className="flex justify-between">
          ...
          <div className="flex">
            ...
            <label htmlFor="login_modal" className="btn btn-primary" onClick={() => {
              setEmail("");
              setPassword("");
            }} >Login</label>
          </div>
        ...
        <input type="checkbox" id="createaccount_modal" className="modal-toggle" />
        <div className="modal">
          <div className="modal-box">
            <div className="flex justify-between items-center">
              <h3 className="font-bold text-lg">Create Account</h3>
              <label htmlFor="createaccount_modal" className="btn btn-circle">
            ...
            <div className="modal-action">
              <label htmlFor="createaccount_modal" className="btn btn-primary w-full" onClick={() => {
                createAccount();
        ...
        <div className="modal">
          <div className="modal-box">
            ...
            <div className="form-control w-full">
              ...
              <input type="text" placeholder="Password" className="input input-bordered w-full" value={password} onChange={(e) => setPassword(e.target.value)} />
            </div>
            <div className="modal-action">
